...
do
    ...
    result_bcast=$(mpirun --map-by core -np $processes --mca coll_tuned_use_dynamic_rules true --mca coll_tuned_bcast_algorithm 3 osu_gather -m $size -x $repetitions -i $repetitions | tail -n 1 | awk '{print $2}')
